...
<body>
    ...
    if(isset($_POST['add_item'])) {
        ...
        if(isset($_SESSION['cart'][$addItemName])) {
            ...
            $_SESSION['cart'][$addItemName]['quantity']++;
        } else {
    ...
    $sqlstatement = $conn->prepare(
        "SELECT dl.location_name, fi.item_name, fi.cost, fi.item_type, i.ingredient_name, a.allergen
    ...
    while ($row = $result->fetch_assoc()) {
        switch ($row['item_type']) {
            ...
            case 'Drink':
                ...
                break;
            default:
                // Handle any other item types if needed
                break;
        }
    }
    ...
    echo "<div class=\"container-row center\">";
        ...
        // If no results found
            ...
            echo "<h2 class=\"center\">No Items Found</h2>";
        }
